    ...
    <div className="fixed inset-0 z-50 flex justify-center overflow-y-auto">
      ...
      <div className="relative z-10 w-full max-w-lg flex flex-col my-auto py-6 px-4">
        <div className="flex justify-end mb-2">
          <button
            onClick={close}
            className="w-11 h-11 rounded-full bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 shadow hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors border border-transparent dark:border-slate-800 flex items-center justify-center active:scale-95 duration-150 cursor-pointer"
